        ...
        <div key={bundle.year} className="on-this-day-year">
          ...
          {bundle.episodes.map(episode => (
            <div key={episode.id} className="on-this-day-episode">
              <div className="on-this-day-episode-title-row">
                <span className="on-this-day-episode-type">
                  {episode.episode_type === 'dm' ? 'DM' : episode.episode_type === 'comment' ? '댓글' : '리스닝파티'}
                </span>
                <h4 className="on-this-day-episode-title">
